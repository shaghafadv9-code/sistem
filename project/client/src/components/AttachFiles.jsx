...
import { api, q, downloadFile, getToken } from '../lib/api.js';
      ...
      <div className="space-y-1.5">
        {rows.map(f => (
          <div key={f.id} className="flex items-center gap-2 rounded-xl px-3 py-2 text-[12.5px]" style={{ background: 'var(--card2)' }}>
            ...
            <button type="button" className="icon-btn !w-7 !h-7" onClick={() => downloadFile(f.id, f.original_name).catch(() => {})} title="تنزيل"><I n="dl" s={14} /></button>
